    ...
    <div className="container py-8">
      <div className="max-w-2xl mx-auto mb-12">
        ...
        {query.length > 0 && query.length < 2 && (
          <p id="search-hint" className="text-sm text-muted-foreground mt-2 text-center">
            Enter at least 2 characters to search
          </p>
        )}
      </div>

      {/* Search results with aria-live for screen readers */}
      <div aria-live="polite" aria-atomic="true">
        {isLoading ? (
          ...
          <div className="text-center py-12 text-muted-foreground">
            <Search className="h-16 w-16 mx-auto text-muted-foreground/30 mb-4" aria-hidden="true" />
