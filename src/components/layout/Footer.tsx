...
export function Footer() {
  return (
    <footer className="relative z-10 py-14 px-6">
      <div className="divider-genesis mb-14" />
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
          {/* Logo */}
          <Link href="/">
            <span className="text-xl font-semibold tracking-genesis-tight text-genesis">
              AI DECK
            </span>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            {socialLinks.map((link) => (
              <a
                ...
                className="text-genesis-muted hover:text-genesis transition-colors"
        ...
        <p className="text-center text-genesis-muted text-sm mt-12 font-light">
          © {new Date().getFullYear()} AI Deck. Crafted with care.
        </p>
      </div>
    </footer>
  )
